...
// Enhanced CORS configuration (with the client URL from environment variables)
const corsOptions = {
  origin: process.env.VITE_CLIENT_URL || "http://localhost:5173", // Allow your client URL
